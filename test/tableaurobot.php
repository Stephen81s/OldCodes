...
function envoimail($message_mail)
{
...
<!--
<form>
<input type="submit" name= "envoyer" value= "envoyer" onclick="<?php  envoimail($message_mail); ?>">
</form>
-->
...
<form>
  <input type="submit" name="envoyer" value="envoyer" onclick= "<?php  envoimail($message_mail); ?>"></form>
</body>
</html>
